...
注意: 必ず1問1空欄、形式は「___」で統一。""",
    "選択問題": """# 問題タイプ: 選択問題（4択）
全問、問題本文の後に①②③④の4つの選択肢を必ず並べてください。

【qフィールドの必須フォーマット】
"(問題本文)  ① 選択肢1  ② 選択肢2  ③ 選択肢3  ④ 選択肢4"

【良い例】
q: 「2.3 + 1.8 の答えはどれですか。  ① 3.1  ② 4.1  ③ 4.0  ④ 5.1」
a: 「② 4.1」

q: 「リンゴが12個あります。3人で同じ数ずつ分けると、1人何個もらえますか。  ① 3個  ② 4個  ③ 5個  ④ 6個」
a: 「② 4個」

【ダメな例】
- 問題本文だけで選択肢がない（必ずNG）
- 選択肢が3つ以下
- 答えが「② 4.1」ではなく「②」だけや「4.1」だけ（番号と内容が両方必要）
